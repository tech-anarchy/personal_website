let projects = [
    {
        ...
        link_active: "portfolio-inactive",
...
for (let i in projects){
    ...
    document.write('<div class="col-md-4 project-item portfolio-item filter-' + projects[i].tag + '">\n' +
        ...
        '                    <a href="' + projects[i].link + '" class="portfolio-details-lightbox ' + projects[i].link_active + '" data-glightbox="type: external" title="Portfolio Details"><i class="bx bx-link"></i></a>\n' +
        '                  </div>\n' +
        '                </div>\n' +
        '\n' +
        '            </div>\n' +
